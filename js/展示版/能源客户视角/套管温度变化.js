...
var table_data = {
    "data": [{
            ...
            "table": [{
                ...
                "data": [{
                        "categoryName": "A相",
                        "start_color": mainGroup['tgwdbh']['one'][0],
                        "end_color": mainGroup['tgwdbh']['one'][1],
                        'high_color': '#5ceaff',
                        "categoryData": [{
                                "xLabel": "2015",
                                "yLabel": "40"
                        ...
                        "categoryName": "B相",
                        "start_color": mainGroup['tgwdbh']['two'][0],
                        "end_color": mainGroup['tgwdbh']['two'][1],
                        'high_color': '#5ceaff',
                        "categoryData": [{
                                "xLabel": "2015",
                                "yLabel": "47"
                        ...
                        "categoryName": "C相",
                        "start_color": mainGroup['tgwdbh']['three'][0],
                        "end_color": mainGroup['tgwdbh']['three'][1],
                        'high_color': '#5ceaff',
                        "categoryData": [{
                                "xLabel": "2015",
                                "yLabel": "45"
...
var showRealData = ZSB["能源客户视角"]["套管温度变化"];
$(function() {
    Flush();
    $.ajax({
