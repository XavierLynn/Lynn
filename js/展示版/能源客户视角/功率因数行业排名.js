...
var showRealData = ZSB["能源客户视角"]["功率因数行业排名"];
$(function() {
    Flush();
    $.ajax({
...
function Flush(){
    ...
    $('.nav a').click(function() {
        ...
        $('.erji_title').click(function() {
            ...
            tabvar += "   <td></td>";
            tabvar += "    <td style='width:950px;height:50px;text-align:center;border-bottom: 2px #ffffff solid;border-left: 2px #ffffff solid;'>";
            tabvar += "         <text class='label'>" + "优" + "</text>";
            tabvar += "    </td>";
            //竖间隔
            tabvar += "    <td style='width:230px;'>";
            tabvar += "    </td>";

            tabvar += "    <td style='width:950px;height:50px;text-align:center;border-bottom: 2px #ffffff solid;border-right: 2px #ffffff solid;'>";
