    ...
    "data": [{
        ...
        "table": [{
            ...
            "data": [
                ...
                {
                    "categoryName": "楼层消耗",
                    "start_color": mainGroup['glcnh']['one'][0],
                    "end_color": mainGroup['glcnh']['one'][1],
                ...
                {
                    "categoryName": "先进值",
                    "start_color": mainGroup['glcnh']['two'],
                    "end_color": mainGroup['glcnh']['two'],
                    'high_color1': '#F2F2F2', //'#ed5f00',
                    'high_color2': '#fce700',
                    "arvg": '26',
                    "categoryData": [{
...
var showRealData = ZSB["能源客户视角"]["各楼层能耗"];
$(function() {
    Flush();
    $.ajax({
