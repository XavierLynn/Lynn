...
var showRealData = ZSB["政府视角"]["区域能源消费比例"];
$(function() {
    Flush();
    $.ajax({
        url: "http://localhost:2277/展示版/ZFSJ.asmx/GetQuYuNYXFBL",
        type: "POST",
        async: true,
    ...
    $('.nav a').click(function() {
        ...
        $('.erji_title').click(function() {
            ...
            option = {
                ...
                color: [mainGroup['qynyxfbl']['one'],
                    mainGroup['qynyxfbl']['two'],
                    mainGroup['qynyxfbl']['three'],
                    mainGroup['qynyxfbl']['four'],
                    mainGroup['qynyxfbl']['five'],
                    mainGroup['qynyxfbl']['six'],
                    mainGroup['qynyxfbl']['seven'],
                    mainGroup['qynyxfbl']['eight']
                ],
                series: series,
                animationDuration: 0
            };
