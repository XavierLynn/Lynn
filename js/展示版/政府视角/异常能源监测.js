...
var table_data = {
    "data": [{
            "title": "异常用能监测",
            "table": [
                {"title": "本月异常用能事件", "xLabel": "", "yLabel": "17"},
                {"title": '待复查异常事件',  "xLabel": "", "yLabel": "42" },
                {"title": '去年经济增加值', "xLabel": "", "yLabel": "7"}, 
            ]
        }
    ]   
};
var showRealData = ZSB["政府视角"]["区域概况"];
$(function() {
    Flush();
    $.ajax({
        url: "http://localhost:2277/展示版/ZFSJ.asmx/GetQuYuGK",
        type: "POST",
        async: true,
