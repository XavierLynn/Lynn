var table_data = {
    ...
    // "image":"http://www.engtron.com/YCKJ/EChartSimple/raw/master/Image/%E6%94%BF%E5%BA%9C%E8%A7%86%E8%A7%92/%E4%BC%81%E4%B8%9A%E6%A6%82%E5%86%B5.png",
    "image-size":[590,590],
    "data": [
        { value: "所属分区：张江南区" },
        { value: "行业类型：制造业" },
...
var showRealData = ZSB["政府视角"]["企业概况"];
$(function() {
    Flush();
    $.ajax({
        url: "http://localhost:2277/展示版/ZFSJ.asmx/GetQYGK",
        type: "POST",
        async: true,
        data: "enteId=94BFAE5209AA44A1969C3AFA13870517",
        error: function() {
            Flush();
