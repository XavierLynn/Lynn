...
var showRealData = ZSB["政府视角"]["企业能源消费排行"];
$(function() {
    Flush();
    $.ajax({
        url: "http://localhost:2277/展示版/ZFSJ.asmx/GetRegionEnteNHTOP",
        type: "POST",
        async: true,
        data: "regionID=zj&startDate=2018-01&endDate=2018-02&topCount=12",
        error: function() {
            Flush();
