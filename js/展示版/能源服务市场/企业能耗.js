...
var table_data = {
    "data": [{
            ...
            "table": [{
                ...
                "data": [{
                    "categoryName": "类别一",
                    "start_color": 'rgba(0,253,173,0.3)',
...
var showRealData = ZSB["能源服务市场"]["企业能耗"];
                        ...
                        if (table_data['data'][i]['table'][j]['title'] === $(this).text()) {
                            ...
                            for (var k = 0; k < table_data['data'][i]['table'][j]['data'].length; k++) {
                                ...
                                for (var m = 0; m < table_data['data'][i]['table'][j]['data'][k]['categoryData'].length; m++) {
                                    ...
                                    yMax = table_data['data'][i]['table'][j]['data'][k]['categoryData'][m]['yLabel']
                                    if (yMax / 10 > 10) {
                        ...
                        areaStyle: {
                            normal: {
                                color: {
                                    ...
                                    colorStops: [{
                                            offset: 0,
                                            color: mainGroup['nxhb']['one'] // 0% 处的颜色
                                        },

                                        {
                                            offset: 1,
                                            color: mainGroup['nxhb']['two'] // 100% 处的颜色
                                        }
                                    ],
