...
var showRealData = ZSB["能源服务市场"]["客户行业分析"];
        ...
        $('.erji_title').click(function() {
            ...
            for (var i = 0; i < y_data.length; i++) {
                ...
                dv.transform({
                    type: 'sort',
                    callback(a, b) {
                        return a.xLabel.length - b.xLabel.length;
                    }
                })
                ...
                dataView.intervalStack().position('yLabel').color('xLabel', [mainColor]).opacity(1).shape('sliceShape').tooltip(false).label('percent', {
                    offset: -20,
                    textStyle: {
                        fill: 'white',
                        fontSize: 30,
