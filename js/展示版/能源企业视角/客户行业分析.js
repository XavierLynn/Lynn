...
var table_data = {
    "data": [{
        ...
        "table": [{
            ...
            "data": [{
                "categoryName": "类别一",
                "start_color": mainGroup['khhyfx']['one'],
                "end_color": mainGroup['khhyfx']['one'],
...
var showRealData = ZSB["能源企业视角"]["客户行业分析"];
$(function() {
    Flush();
    $.ajax({
                    ...
                    for (var j = 0; j < table_data['data'][i]['table'].length; j++) {
                        if (table_data['data'][i]['table'][j]['title'] === $(this).text()) {
                            ...
                            for (var k = 0; k < table_data['data'][i]['table'][j]['xLabelRang'].length; k++) {
                                ...
                                x_label.push(table_data['data'][i]['table'][j]['xLabelRang'][k]['label'].replace(reg, '\n'))
                            }
...

                    {
                        ...
                        itemStyle: itemStyle = {
                            ...
                            emphasis: {
                                ...
                                shadowOffsetX: 0,
                                shadowOffsetY: 0,
                                shadowColor: mainGroup['khhyfx']['one']
                            }
                        },
                        barWidth: '160px',
                        label: {
