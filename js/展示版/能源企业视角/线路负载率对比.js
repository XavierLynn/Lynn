...
var showRealData = ZSB["能源企业视角"]["线路负载率对比"];
$(function() {
    Flush();
    $.ajax({
        ...
        "data": [{
            ...
            "table": [{
                ...
                "data": [{
                    ...
                    {
                        "categoryName": "预计",
                        "icon": "image://http:engtron.com/YCKJ/EChartSimple/raw/master/Image/%E8%83%BD%E6%BA%90%E4%BC%81%E4%B8%9A%E8%A7%86%E8%A7%92/legndIcon.png",

                        "lineStyle": "dashed",
                        "start_color": mainGroup['xlfzldb']['two'],
                        "end_color": mainGroup['xlfzldb']['two'],
