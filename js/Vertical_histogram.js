        ...
        $('.erji_title').click(function () {
            ...
            for (var i = 0; i < y_data.length; i++) {
                if (i === 0) {
                    ...
                    series.push({
                        name: new_liebie[i], type: 'bar', barGap: 0, markLine: markline, itemStyle: itemStyle, barWidth: '20%', label: label, data: y_data[i], color: function (params) {
                    ...
                    const colorList = new_color_list[i];
                    series.push({
                        name: new_liebie[i], type: 'bar', barGap: 0, itemStyle: itemStyle, barWidth: '20%', label: label, data: y_data[i], color: function (params) {
                            return colorList[params.dataIndex]
                        }
                    })
                }
