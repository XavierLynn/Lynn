...
function Flush(){
    ...
    var table_data = {
        "data": [{
            ...
            "table": [{
                "title": "总",
                "unit": "kw",
                // "companyName": ["XXX重工集团有限公司", "XXX能源服务公司", "XXX科技有限公司", "XXX服务有限公司"],
                "xLabelRang": [{
                        "label": "11:00"
                    },
                    {
    ...
    $('.nav a').click(function() {
        ...
        // function CurrentData(dataIndex, obj) {
        ...
        //                 if (table_data['data'][i]['table'][j]['title'] === obj) {
        //                     unit = table_data['data'][i]['table'][j]['unit'];
        //                     // companyName = table_data['data'][i]['table'][j]['companyName'];
        //                     // alert(companyName)
        //                     for (var k = 0; k < table_data['data'][i]['table'][j]['xLabelRang'].length; k++) {
        //                         x_label.push(table_data['data'][i]['table'][j]['xLabelRang'][k]['label'])
        //                     }
        //                     for (var k = 0; k < table_data['data'][i]['table'][j][dataIndex].length; k++) {

        //                         const color_res = []; // 颜色过渡数组
        //                         leibie_name.push(table_data['data'][i]['table'][j][dataIndex][k]['categoryName']);
        //                         color_res.push(table_data['data'][i]['table'][j][dataIndex][k]['start_color']);
        //                         color_res.push(table_data['data'][i]['table'][j][dataIndex][k]['end_color']);
        //                         color_res.push(table_data['data'][i]['table'][j][dataIndex][k]['high_color']);
        //                         color_res.push(table_data['data'][i]['table'][j][dataIndex][k]['gradient_color']);
        //                         lineType.push(table_data['data'][i]['table'][j][dataIndex][k]['lineStyle']);
        //                         legendData.push({
        //                             name: table_data['data'][i]['table'][j][dataIndex][k]['categoryName'],
        //                             icon: table_data['data'][i]['table'][j][dataIndex][k]['icon'],
        //                         })
        //                         const res = []; // y_data 过渡数组
        //                         for (var m = 0; m < table_data['data'][i]['table'][j][dataIndex][k]['categoryData'].length; m++) {
        //                             res.push(table_data['data'][i]['table'][j][dataIndex][k]['categoryData'][m]['yLabel'])
        //                         }
        //                         y_data.push(res);
        ...
        $('.erji_title').click(function() {
            ...
            // alert(series);
            // series1 = CurrentData("data1");
            // series2 = CurrentData("data2");
            // series3 = CurrentData("data3");
