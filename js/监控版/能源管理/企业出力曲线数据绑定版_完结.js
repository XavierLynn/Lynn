...
var showRealData = JKB["能源管理"]["企业出力曲线数据绑定版_完结"]
...
function Flush(){
    ...
    //初始化底部的页标记
    var length = Math.ceil(table_data["table"].length / 2);
    let tabvar = "";
    ...
    $(".tabItem").click(function () {
        ...
        //根据选择的页标记，加载对应页码的数据
        $("#show_Panel").empty();
        for (let index = pageIndex * 2; index < ((pageIndex + 1) * 2); index++)
    ...
    function CreateDataCard(inData, inIndex) {
        ...
        tabvar += "<label class='titleLeft'></label>";
        tabvar += "<label class='titleContent'>&nbsp;" + inData["title"] + "&nbsp;</label>";
        tabvar += "<label class='titleRight'></label>";
        tabvar += "</button>";
        tabvar += "</div>";
        tabvar += "<div class='tablePanel'>";
        tabvar += "<table width='100%' height='100%'>";
        tabvar += "<tr>";
        tabvar += "<td class='tableTitle' width='40%'>计划量</td>";
        tabvar += "<td class='tableTitle' width='20%'></td>";
        tabvar += "<td class='tableTitle' width='40%'>完成量</td>";
        tabvar += "</tr>";
        tabvar += "<tr>";
        tabvar += "<td class='tableContent' width='40%'>" + inData["计划量"] + "</td>";
        tabvar += "<td class='tableTitle' width='20%'></td>";
        tabvar += "<td class='tableContent' width='40%'>" + inData["完成量"] + "</td>";
        tabvar += "</tr>";
        tabvar += "<tr>";
        tabvar += "</tr>";
        tabvar += "<tr>";
        tabvar += "</tr>";
        tabvar += "<tr>";
        tabvar += "<td class='tableTitle' width='40%'>完成度</td>";
        tabvar += "<td class='tableTitle' width='20%'></td>";
        tabvar += "<td class='tableTitle' width='40%'>出力排行</td>";
        tabvar += "</tr>";
        tabvar += "<tr>";
        tabvar += "<td class='tableContent' width='40%'>" + inData["完成度"] + "</td>";
        tabvar += "<td class='tableTitle' width='20%'></td>";
        tabvar += "<td class='tableContent' width='5400%'>" + inData["出力排行"] + "</td>";
        tabvar += "</tr>";
        tabvar += "</table>";
        tabvar += "</div>";
