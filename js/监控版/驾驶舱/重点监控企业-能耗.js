...
var table_data = {
    "data": [{
        ...
        "table": [{
            ...
            "data": [{
                    "categoryName": "XXX照明公司",
                    "start_color": "rgba(231,251,255,0.5)",
                ...
                {
                    "categoryName": "XXX科技有限公司",
                    "start_color": "rgba(65,105,225,0.5)",
                    "end_color": "rgba(65,105,225,1)",
...
$(function() {
    Flush();
    $.ajax({
        url: "http://localhost:2277/监控版/JSC.asmx/GetEnteEnergyConsumptionMonth",
        type: "POST",
        async: true,
        data: "elecIDList=1352958966,0060819150&startDate=2019-12&endDate=2020-01",
        error: function() {
            Flush();
