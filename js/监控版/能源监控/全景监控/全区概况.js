    ...
    "data": [{
        ...
        "table": [
            ...
            [{ "name": "当月清洁能源消纳率", "value": "100%", "unit": "" },
                ...
                { "name": "上月经济增加值", "value": "--", "unit": "万元" },
            ],
            [{ "name": "当月能耗总量", "value": "3.76", "unit": "万tce" },
                { "name": "当月度电经济增加值", "value": "--", "unit": "万/kwh" },
                { "name": "当月万元产值能耗", "value": "--", "unit": "tce/万" },
                { "name": "当月单位建筑面积能耗", "value": "--", "unit": "tce/km³" },
            ]
        ]
    }]
};
var showRealData = JKB["能源监控"]["全景监控"]["全区概况"]
$(function() {
    Flush();
    $.ajax({
        url: "http://localhost:2277/监控版/NYJK.asmx/GetRegionEnteRatio",
        type: "POST",
        async: true,
        data: "regionID=zj",
        error: function() {
