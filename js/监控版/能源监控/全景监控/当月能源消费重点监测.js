...
var showRealData =JKB["能源监控"]["全景监控"]["当月能源消费重点监测"];
$(function() {
    Flush();
    $.ajax({
        url: "http://localhost:2277/监控版/NYJK.asmx/GetEnteEnergyConsumptionMonth",
        type: "POST",
        async: true,
        data: "elecIDList=1352958966&startDate=2019-12&endDate=2020-01",
        error: function() {
            Flush();
