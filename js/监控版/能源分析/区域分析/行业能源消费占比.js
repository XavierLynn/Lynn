...
var showRealData = JKB["能源分析"]["区域分析"]["产业能源消费占比"];
                    ...
                    for (var j = 0; j < table_data['data'][i]['table'].length; j++) {
                        if (table_data['data'][i]['table'][j]['title'] === $(this).text()) {
                            ...
                            for (var k = 0; k < table_data['data'][i]['table'][j]['data'].length; k++) {
                                ...
                                for (var m = 0; m< table_data['data'][i]['table'][j]['data'][k]['categoryData'].length-1; m++) {
                                    for(var l = 0; l < table_data['data'][i]['table'][j]['data'][k]['categoryData'].length-1; l++)
                                    {
                                        preNum = table_data['data'][i]['table'][j]['data'][k]['categoryData'][l]['yLabel'];
                                        curNum = table_data['data'][i]['table'][j]['data'][k]['categoryData'][l+1]['yLabel'];
                                        if(preNum<curNum)
                                        {
                                            temp = table_data['data'][i]['table'][j]['data'][k]['categoryData'][l];
                                            table_data['data'][i]['table'][j]['data'][k]['categoryData'][l] =  table_data['data'][i]['table'][j]['data'][k]['categoryData'][l+1];
                                            table_data['data'][i]['table'][j]['data'][k]['categoryData'][l+1] =temp;
                                        }
                                    }       
                                }
