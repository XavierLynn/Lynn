...
var showRealData = JKB["能源分析"]["区域分析"]["各区域综合能耗"];
...
$(function() {
    Flush();
    $.ajax({
        url: "http://localhost:2277/监控版/NYFX.asmx/GetRegionZHNH",
        type: "POST",
        async: true,
        data: "regionID=zj&startDate=2019-11&endDate=2019-12",
        error: function() {
            Flush();
        },
