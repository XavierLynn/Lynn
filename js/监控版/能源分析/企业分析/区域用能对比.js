...
var showRealData = JKB["能源分析"]["企业分析"]["区域用能对比"]
...
function Flush(){
    ...
    $('.nav a').click(function() {
        ...
        $('.erji_title').click(function() {
            ...
            var stackValue = ['First', 'Second'];
            var HighLightColor = ['rgba(97,173,255,0.9)', 'rgba(209,246,255,0.9)']
            for (var i = 0; i < y_data.length; i++) {
